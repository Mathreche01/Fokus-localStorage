...
const formCloseBtn = document.querySelector('.app__form-footer__button--cancel')
const btnDeletar = document.querySelector('.app__form-footer__button--delete')
const taskAtiveDescription = document.querySelector('.app__section-active-task-description')
const localStorageTarefas = localStorage.getItem('tarefas')
const btnRemoveAllTasks = document.querySelector('#btn-remover-todas')
const btnRemoveCompleteTasks = document.querySelector('#btn-remover-concluidas')
...
btnRemoveAllTasks.addEventListener('click', () => removerTarefas(false))
btnRemoveCompleteTasks.addEventListener('click', () => removerTarefas(true))
